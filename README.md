...
> than get node from the document
	...
	Node item11Node = document.getNode(â€œitems1.item11â€);
	Node item12caNode = document.getNode(â€œitems1.item12.item12c.item12caâ€);
	
> Or if no duplicated keyname

	Node item11Node = document.getNode(â€œitem11â€);
	Node item11Node = document.getNode(â€œitems12caâ€);
...
> finally
	...
	String items12caName = Item12caNode.getName();
	String items12caValue = Item12caNode.getValue();
>>>>>>> d61dc17eb54ac4a71db494fcb78f0ff1597c18fc
